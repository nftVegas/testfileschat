...
if ( $registration_date ) {
    $member_days = floor( ( time() - strtotime( $registration_date ) ) / DAY_IN_SECONDS );
    if ( $member_days >= $series->getLongestPostDelay( 'publish' ) ) {
        ...
        $content .= '<p class="pmpro_series_days_into_membership_text">' . sprintf( __( 'You are on day %d since you registered your account.', 'pmpro-series' ), $member_days ) . '</p>';
    }
}
 else {
